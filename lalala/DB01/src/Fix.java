...
class Fix extends JDialog implements ActionListener
{
   ...
   public Fix(Frame fck,String ckm,Boolean msck,Message xsxx2,int hang)
   {
	   super(fck,ckm,msck);
	   bq1=new JLabel("               学号      ");
	   bq2=new JLabel("               姓名      ");
   ...
   public void actionPerformed(ActionEvent e)
   {
	   if(e.getActionCommand().equals("xiugai"))
	   {
		   ...
		   try {
				  ...
				  String ss=("update stu set named=?,sex=?,age=?,jiguan=?,yuanxi=? where id=?");
